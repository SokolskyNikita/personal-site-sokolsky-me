...
export const LOCATION_REGISTRY: Record<string, LocationEntry> = {
  ...
  "russia-gateways": {
    id: "russia-gateways",
    type: "country",
    label: "Russia gateways",
    continent: "Europe",
    // Top 15 Russian airports by 2024 passenger traffic
    // (Federal Air Transport Agency via Wikipedia).
    airports: [
      "SVO",
      "LED",
      "VKO",
  ...
  "belarus-gateways": {
    id: "belarus-gateways",
    type: "country",
    label: "Belarus gateways",
    continent: "Europe",
    // Top 3 Belarusian airports by passenger traffic / scheduled
    // service scale (MSQ dominates; BQT and GME are the next hubs).
    airports: ["MSQ", "BQT", "GME"],
  },
  "lcc-airports": {
    id: "lcc-airports",
    type: "region",
