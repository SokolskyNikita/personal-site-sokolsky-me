...
export const DECK: QuizQuestion[] = [
  ...
  question("Friday night", "If nobody else gets a vote, how do you spend Friday night?", [
    ...
    ["On a date or talking to someone I want to date.", "romantic", ["Dating-to-marry girl", "Situationship girl", "Delulu dater"]],
  ...
  question("Dating apps", "If you were single and using a dating app, how would you use it?", [
    ...
    ["I would message often and get attached before meeting.", "romantic", ["Pen-pal dater", "Anxious queen", "Delulu dater"]],
  ...
  question("Dating pattern", "Which pattern have you followed most often while dating?", [
    ...
    ["I message for weeks and build a bond before meeting.", "culture", ["Pen-pal dater", "Voice-note girl", "Delulu dater"]],
  ...
  question("Social feed", "What takes up the largest share of your main social-media feed?", [
    ...
    ["Dating advice, relationship stories and attractive couples.", "romantic", ["Relationship-content girl", "Dating-to-marry girl", "Delulu dater"]],
  ...
  question("Reading and watching", "What do you choose most often when you have two hours alone?", [
    ...
    ["A romance, dating show or story about a difficult couple.", "romantic", ["Delulu dater", "Situationship girl", "Fleabag girl", "Girl written by a man", "Golden retriever girlfriend"]],
  ...
  question("Politics", "Which political material do you read or watch most often?", [
    ["Almost none.", "neutral", ["Chill girl", "Basic"]],
    ["Mainstream news and posts shared by people I know.", "social", ["Resistance lib wine mom", "Girlboss feminist"]],
    ...
    ["Women in power, workplace equality and respectable liberal politics.", "polished", ["Girlboss feminist", "Resistance lib wine mom"]],
  ...
  question("Reputation", "Which sentence would your closest friend be most likely to use about you?", [
    ...
    ["'She can turn one text from a man into a two-hour meeting.'", "romantic", ["Group-chat dater", "Anxious queen", "Delulu dater"]],
