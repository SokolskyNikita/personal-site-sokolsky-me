...
export const DECK: QuizQuestion[] = [
  question("Saturday morning", "Which of these are usually part of a free Saturday morning?", [
    ...
    ["Get dressed properly and go somewhere I can take a good photo.", "polished", ["It girl", "Baddie", "Candid girl", ["Coastal grandmother", 1]]],
    ["Thrift, browse records or work on an outfit.", "alt", ["Downtown girl", "Indie sleaze girl", "Alt girl"]],
    ["Work out or take a long walk.", "wellness", ["Pilates princess", "Hot-girl-walk girl"]],
    ["Read, play a game or spend time on my current interest.", "culture", ["BookTok girlie", "Gamer girl", "Hyperfixation girlie", ["Plath girl", 1]]],
    ["Stay in bed and scroll until I know what everyone is arguing about.", "online", ["Terminally online girl", "Doomer girl", "Girlblogger"]],
    ["Make a breakfast I planned.", "wellness", ["That girl", "Wellness girlie"]],
  ]),
  question("Friday night", "If nobody else gets a vote, how do you spend Friday night?", [
    ...
    ["Eating early, doing skincare and protecting my sleep.", "wellness", ["Wellness girlie", "Clean girl", "That girl", ["Coastal grandmother", 1]]],
  ...
  question("Everyday clothes", "What do you wear on an ordinary day when you are not dressing for work?", [
    ...
    ["A coordinated outfit with polished hair, shoes and accessories.", "polished", ["Clean girl", "Old money", "Office siren", "Sloane Ranger", ["Coastal grandmother", 1]]],
  ...
  question("Beauty routine", "Which best describes your hair, makeup and skincare routine on a normal weekday?", [
    ...
    ["I research products, ingredients, treatments or facial structure.", "wellness", ["Looksmaxxer", "Cortisol girlie"]],
  ...
  question("Health habits", "Which statement best describes your current health routine?", [
    ...
    ["I care most about how the routine affects my skin, weight or appearance.", "polished", ["Looksmaxxer"]],
    ...
    ["I research one condition or habit in great depth.", "culture", ["High-masking woman", "Hyperfixation girlie", ["AuDHD girlie", 1]]],
  ...
  question("Conflict", "A close friend tells you that you hurt her. What do you do first?", [
    ...
    ["Think through the exact words and replay the conversation.", "culture", ["High-masking woman", "Fleabag girl", ["Plath girl", 1], ["AuDHD girlie", 0.75]]],
  ...
  question("Social feed", "What takes up the largest share of your main social-media feed?", [
    ...
    ["Fashion, beauty, interiors and luxury.", "polished", ["Clean girl", "Old money", "Baddie", ["Coastal grandmother", 1]]],
  ...
  question("Reading and watching", "What do you choose most often when you have two hours alone?", [
    ...
    ["A novel, art film, game or deep dive into a subject.", "culture", [["Sad lit girl", 3], "Letterboxd girl", "Hyperfixation girlie", ["\"My Year of Rest and Relaxation\" girl", 3], ["AuDHD girlie", 0.75]]],
  ...
  question("Home", "Which description is closest to your current living space?", [
    ...
    ["Coordinated, clean and chosen to photograph well.", "polished", ["Vanilla girl", "Sad beige mom", "Quiet luxury", ["Coastal grandmother", 3], "Cottagecore", "Light academia"]],
  ...
  question("Belief", "Which statement is closest to what you actually believe?", [
    ...
    ["I look for meaning in books, art, psychology or philosophy.", "culture", [["Joan Didion girl", 1], "Fleabag girl", "Art hoe", ["Plath girl", 1]]],
  ...
  question("Politics", "Which political material do you read or watch most often?", [
    ...
    ["Long essays, history and cultural criticism.", "culture", [["Joan Didion girl", 1], "Girlblogger", "Performative reader girl", ["Plath girl", 1]]],
  ...
  question("Advice", "What do friends ask you for help with most often?", [
    ...
    ["Workouts, food, sleep, skincare or supplements.", "wellness", ["Wellness girlie", "Cortisol girlie", "Pilates princess"]],
  ...
  question("Travel", "When you plan a trip for yourself, what matters most?", [
    ...
    ["A beautiful hotel, good clothes and places I want in photos.", "polished", ["It girl", "Old money", "Candid girl", ["Coastal grandmother", 1]]],
    ...
    ["Museums, bookstores, music, history or a specific event.", "culture", ["Letterboxd girl", "BookTok girlie", "Concert girlie", ["Plath girl", 1]]],
  ...
  question("Texting", "Which pattern appears most often in your text messages?", [
    ...
    ["Long explanations, quotations and links.", "culture", ["Fleabag girl", "Girlblogger", "Hyperfixation girlie", ["Plath girl", 1], ["AuDHD girlie", 0.75]]],
  ...
  question("Food", "How do you decide what to eat on a normal day?", [
    ...
    ["I care about the restaurant, plating and how the table looks.", "polished", ["Tomato girl", "Old money", "It girl", ["Coastal grandmother", 1]]],
  ...
  question("Interests", "What happens when you become interested in something new?", [
    ...
    ["I read everything, learn the terms and talk about it for hours.", "culture", ["Hyperfixation girlie", "Horse girl", ["AuDHD girlie", 2]]],
  ...
  question("Reputation", "Which sentence would your closest friend be most likely to use about you?", [
    ...
    ["'She knows far too much about one book, game, film or horse.'", "culture", ["Hyperfixation girlie", "Gamer girl", "Horse girl", ["AuDHD girlie", 1]]],
